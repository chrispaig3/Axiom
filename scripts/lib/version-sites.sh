...
#
# WHY THIS FILE EXISTS. `check-version.sh` already knew all seventeen
# sites and how to read each one - that is the hard half, and it was the
# only half automated. Bumping was seventeen hand edits across four file
