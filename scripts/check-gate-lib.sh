...
# is the preamble sixty-eight gates share, and `gate_build_axc` is the
...
# one of those sixty-eight gates at once - and the failure would look like
...
echo "                was built from the tree as it stands, so sixty-eight gates"
