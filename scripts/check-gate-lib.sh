...
# is the preamble seventy-two gates share, and `gate_build_axc` is the
...
# one of those seventy-two gates at once - and the failure would look like
...
echo "                was built from the tree as it stands, so seventy-two gates"
