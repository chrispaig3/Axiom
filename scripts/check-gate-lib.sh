...
# is the preamble seventy-three gates share, and `gate_build_axc` is the
...
# one of those seventy-three gates at once - and the failure would look like
...
echo "                was built from the tree as it stands, so seventy-three gates"
