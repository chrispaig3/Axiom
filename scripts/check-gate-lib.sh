...
# is the preamble sixty-five gates share, and `gate_build_axc` is the
...
# one of those sixty-five gates at once - and the failure would look like
...
echo "                was built from the tree as it stands, so sixty-five gates"
