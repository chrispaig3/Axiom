...
# is the preamble fifty-seven gates share, and `gate_build_axc` is the
...
# one of those fifty-seven gates at once - and the failure would look like
...
echo "                was built from the tree as it stands, so fifty-seven gates"
