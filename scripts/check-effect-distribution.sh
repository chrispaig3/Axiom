...
have "$(bucket "$work/main.axsym" 'Alloc,Mut')" 2177 "exactly Alloc,Mut"
...
have "$(grep '^F ' "$work/main.axsym" | grep -vc '#effects=\|#effects-incomplete' || true)" 1687 "pure (neither row nor mark)"
