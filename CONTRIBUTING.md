...
│                       Intern, Sys, IO, Path, Json, Rpc, Utf8, Err, Job,
...
| Add a stdlib function | `stdlib/` — `Pre`, `Mem`, `Str`, `Vec`, `Map`, `Fmt`, `Intern`, `Sys`, `IO`, `Path`, `Json`, `Rpc`, `Utf8`, `Err`, `Job`, `Ffi` |
...
1. **Add it to the appropriate module** in `stdlib/` — `Pre`, `Mem`,
   ...
   `Rpc`, `Utf8`, `Err`, `Job`, `Html`, `Http`, `Ffi`.
