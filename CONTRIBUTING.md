...
2026-09-03, `axiom fmt --check` over every one of the 599 `.ax` files
in the repository answers `is already formatted` for 483 of them and
`needs formatting` for 116. Two of the 116 are deliberate and are named
below; the other 114 were committed unformatted, and that same sweep is
